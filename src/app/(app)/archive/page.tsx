...
export default async function ArchivePage() {
  ...
  const [tasks, broods] = await Promise.all([
    getArchivedTasks(user),
    ...
    <div className="animate-rise">
      <header className="mb-8">
        ...
        <p className="mt-1 text-sm text-muted">
          Completed tasks and deleted broods.
        </p>
      </header>

      {broods.length > 0 && (
        <section className="mb-8">
          <h2 className="mb-2 font-mono text-xs uppercase tracking-[0.2em] text-faint">
            Deleted broods · {broods.length}
          </h2>
